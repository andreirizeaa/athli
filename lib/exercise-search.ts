...
const mockExercises: Exercise[] = [
  ...
  },
  {
    ...
    overview: "The Squat is a fundamental compound exercise that targets the quadriceps, glutes, and hamstrings. It's essential for building lower body strength and improving functional movement patterns.",
    instructions: [
  ...
  },
  {
    ...
    overview: "The Deadlift is a compound exercise that primarily targets the posterior chain, including the back, glutes, and hamstrings. It's one of the most effective exercises for building overall strength.",
    instructions: [
  ...
  },
  {
    ...
    overview: "The Overhead Press is a compound exercise that targets the shoulders and triceps while also engaging the core for stability. It's excellent for building upper body strength and improving shoulder mobility.",
    instructions: [
  ...
  },
  {
    ...
    overview: "The Pull Up is a bodyweight exercise that primarily targets the latissimus dorsi, biceps, and upper back. It's an excellent exercise for building upper body pulling strength.",
    instructions: [
  ...
  },
  {
    ...
    overview: "Running is a fundamental cardiovascular exercise that improves heart health, endurance, and overall fitness. It can be performed at various intensities and distances.",
    instructions: [
