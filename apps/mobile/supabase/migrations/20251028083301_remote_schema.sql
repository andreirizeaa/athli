...
CREATE OR REPLACE TRIGGER "lift-complete" AFTER INSERT ON "public"."lifts" FOR EACH ROW EXECUTE FUNCTION "supabase_functions"."http_request"('https://dsvyhorkfdcqjrjiqefe.supabase.co/functions/v1/push-notifications', 'POST', '{"Content-type":"application/json","Authorization":"Bearer SUPABASE_SERVICE_ROLE_KEY_2_REDACTED"}', '{}', '5000');



CREATE OR REPLACE TRIGGER "lift-failure" AFTER INSERT ON "public"."lift_failures" FOR EACH ROW EXECUTE FUNCTION "supabase_functions"."http_request"('https://dsvyhorkfdcqjrjiqefe.supabase.co/functions/v1/push-notifications', 'POST', '{"Content-type":"application/json","Authorization":"Bearer SUPABASE_SERVICE_ROLE_KEY_2_REDACTED"}', '{}', '5000');
