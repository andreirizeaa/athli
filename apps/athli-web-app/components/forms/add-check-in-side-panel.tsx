...
import { Search, Edit, FileText, Info } from 'lucide-react';
...
export const AddCheckInSidePanel = ({
  ...
  const handleSave = async () => {
    ...
    const scheduleData: AssignFormScheduleData = {
      ...
      selectedDays: checkInFrequency === 'daily' || checkInFrequency === 'weekly' || checkInFrequency === 'biweekly' ? Array.from(selectedDays) : undefined,
      monthlyOption: checkInFrequency === 'monthly' ? monthlyOption : undefined,
      specificDay: checkInFrequency === 'monthly' && monthlyOption === 'specific' ? specificDay : undefined,
    };
