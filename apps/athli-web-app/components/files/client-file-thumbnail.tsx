...
import { getFileTypeFromMime, isExternalLink, isYouTubeUrl, isVimeoUrl, getYouTubeThumbnail } from '@/api/coach/coach-file-service';
...
export const ClientFileThumbnail = ({ file, clientId, coachId, className }: ClientFileThumbnailProps) => {
    ...
    }, [file.id, fileType, clientId, coachId, isLink]);

    const renderContent = () => {
        // Handle external links first
        if (isLink && file.file_path) {
