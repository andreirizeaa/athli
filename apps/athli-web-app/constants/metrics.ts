...
const dailyScheduleMWF: MetricScheduleData = {
  type: 'metric',
  frequency: 'daily',
  selectedDays: ['monday', 'wednesday', 'friday'],
};

const weeklySchedule: MetricScheduleData = {
  type: 'metric',
  frequency: 'weekly',
  selectedDays: ['sunday'],
};

const biweeklySchedule: MetricScheduleData = {
  type: 'metric',
  frequency: 'biweekly',
  selectedDays: ['sunday'],
};

const monthlySchedule: MetricScheduleData = {
  type: 'metric',
  frequency: 'monthly',
  monthlyOption: 'first',
};
