...
1. **Warm-Up** (Regular section) - Band pull-aparts, arm circles
...
2. Click **Add Section**.
3. Choose to create a new section or browse your saved sections from the library.
...
1. After configuring a section inside a workout, click the section menu.
