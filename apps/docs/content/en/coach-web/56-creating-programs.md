...
1. Click and hold a workout card.
2. Drag it to a different day or week.
...
1. Click **Edit Details** in the program builder header.
2. Make your changes.
3. Click **Save**.
...
1. Click on the workout card in the grid.
