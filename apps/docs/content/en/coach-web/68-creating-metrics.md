...
3. Enter the **name** (e.g., "Body Weight", "Waist Circumference", "Squat 1RM")
4. Select the **type**:
...
5. Set the **unit** (kg, lbs, cm, inches, %, steps, seconds, etc.)
...
1. In **Library > Metrics**, click **Create Folder**
2. Name the folder (e.g., "Body Composition", "Performance", "Wellness")
...
4. Browse or search your metric library
