...
1. Click the **+** button inside the section to add exercises.
...
1. Click on the rest field for the exercise.
2. Enter the rest time in seconds between sets.
3. Each exercise can have its own rest period.
