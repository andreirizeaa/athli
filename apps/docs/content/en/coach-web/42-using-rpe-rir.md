...
| RPE | RIR | Meaning |
|-----|-----|---------|
| 10 | 0 | Maximum effort, no reps left (failure) |
| 9 | 1 | Could have done 1 more rep |
...
Use whichever your client understands best. RIR is generally more intuitive for beginners, while RPE is standard in powerlifting and advanced programming.

**Can I prescribe RPE for cardio exercises?**
RPE can be applied to any exercise type. For cardio, it maps to perceived effort during the activity.

**What if my client always reports RPE 10?**
This may indicate the programming is too heavy, the client is not accurately assessing their exertion, or they need coaching on the RPE scale. Review their performance data and have a conversation about calibration.

**Can I track RPE trends over time?**
Yes. Logged RPE/RIR data is stored with each session and can be reviewed in the client's progress history.
