...
CREATE TRIGGER messages AFTER INSERT ON public.messages FOR EACH ROW EXECUTE FUNCTION supabase_functions.http_request('https://bxgbbpiswmauqdqkkaha.supabase.co/functions/v1/message-push-notification', 'POST', '{"Content-type":"application/json","Authorization":"Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJ4Z2JicGlzd21hdXFkcWtrYWhhIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2Mzc0MTMxNSwiZXhwIjoyMDc5MzE3MzE1fQ.Aii_EdYrDWF1kZye1HzqwS0xjM4yZQBkYYfLrlLEnZw"}', '{}', '5000');
