...
CREATE OR REPLACE VIEW "public"."musclewiki_compliance_report" WITH ("security_invoker"='on') AS
...
COMMENT ON TABLE "public"."musclewiki_exercise_cache" IS 'Cache for MuscleWiki API exercise metadata including thumbnail URLs.
...
COMMENT ON COLUMN "public"."musclewiki_exercise_cache"."thumbnail_url" IS 'MuscleWiki CDN URL for exercise thumbnail. This is metadata (text), not the
