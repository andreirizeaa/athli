-- ================================================
-- Rename push notification edge functions for consistency
-- ================================================
-- Renames:
-- - client-assignment-notification -> client-assignment-push-notification
-- - habit-reminder-notification -> habit-reminder-push-notification
--
-- This migration updates the trigger function to call the renamed edge function.
  ...
  BEGIN
    ...
    IF v_supabase_url IS NOT NULL AND v_service_key IS NOT NULL THEN
      SELECT net.http_post(
        url := v_supabase_url || '/functions/v1/client-assignment-push-notification',
