-- Fix handle_user_update() - critical bug introduced in migration 185
-- Bug: Used "coach_id" column which doesn't exist in coach_profiles table
-- Fix: Use "id" column (the actual primary key of coach_profiles)
