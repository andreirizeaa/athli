    ...
    <div className={cn('relative', className)}>
      <Tabs value={value} defaultValue={defaultTabValue} onValueChange={onValueChange}>
        <div className="-mx-4 overflow-x-auto no-scrollbar">
          <div className="relative min-w-fit px-4">
