...
import {
  ...
  type LocalClientQuestionnaireDetail,
} from '@/api/client/client-form-service';
import { toast } from 'sonner';

type EditClientQuestionnaireFormSidePanelProps = {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  form: LocalClientQuestionnaireDetail | null;
  clientId: string;
  coachId: string;
  onSave?: (form: LocalClientQuestionnaireDetail) => void;
  onDelete?: () => void;
};
...
export const EditClientQuestionnaireFormSidePanel = ({
  open,
  onOpenChange,
  form,
  clientId,
  ...
  onSave,
  onDelete,
}: EditClientQuestionnaireFormSidePanelProps) => {
  ...
  const handleSave = async (values: FormFormValues) => {
    ...
    setIsSaving(true);
    try {
      const updatedForm = await editClientQuestionnaireDetails({
        clientId,
        coachId,
