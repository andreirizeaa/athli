  ...
  business: {
    ...
    packages: {
      ...
      form: {
        ...
        benefits: 'Benefits',
        benefitPlaceholder: 'e.g. Unlimited messaging',
    ...
    codes: {
      ...
      noCodesSubtitle: 'Create discount codes for your clients',
      columns: {
        name: 'Name',
        code: 'Code',
        discount: 'Discount',
      ...
      toast: {
        ...
        duplicateCode: 'A discount code with this code already exists',
      },
    },
    sequences: {
