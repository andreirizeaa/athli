...
import { AddWorkoutSidePanel } from '@/app/(app)/library/training/workouts/components/add-workout-side-panel';
import { CreateWorkoutSidePanel } from '@/app/(app)/library/training/workouts/components/create-workout-side-panel';
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
import { WorkoutBuilder } from '@/app/(app)/library/training/workouts/workout-builder';
          ...
          <div className="flex flex-col gap-1 flex-1 min-w-0">
            <Breadcrumb>
              <BreadcrumbList className="text-xs gap-1">
                <BreadcrumbItem>
                  <BreadcrumbLink
                    onClick={() => handleBreadcrumbClick('/library/training')}
                ...
                <BreadcrumbItem>
                  <BreadcrumbLink
                    onClick={() => handleBreadcrumbClick('/library/training/programs')}
                    className="cursor-pointer hover:bg-accent hover:text-accent-foreground px-0.5 py-0.5 rounded transition-colors text-foreground"
                  >
