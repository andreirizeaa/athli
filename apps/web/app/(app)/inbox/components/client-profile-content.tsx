...
const ClientOverviewPage = dynamic(() => import('@/app/(app)/athletes/[clientId]/overview/page'), { ssr: false });
const ClientNotesPage = dynamic(() => import('@/app/(app)/athletes/[clientId]/notes/page'), { ssr: false });
const ClientMetricsPage = dynamic(() => import('@/app/(app)/athletes/[clientId]/metrics/page'), { ssr: false });
const ClientHabitsPage = dynamic(() => import('@/app/(app)/athletes/[clientId]/habits/page'), { ssr: false });
const ClientPhotosPage = dynamic(() => import('@/app/(app)/athletes/[clientId]/photos/page'), { ssr: false });
const ClientFilesPage = dynamic(() => import('@/app/(app)/athletes/[clientId]/files/page'), { ssr: false });
const ClientCheckInPage = dynamic(() => import('@/app/(app)/athletes/[clientId]/check-in/page'), { ssr: false });
