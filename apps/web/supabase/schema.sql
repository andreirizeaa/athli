...
1. Creating profiles when user_type is set for the first time (Google OAuth signup flow)
2. Syncing email, name, and profile picture changes to existing profiles

For Google OAuth signup:
- User is created in auth.users without user_type
- INSERT trigger (handle_new_user) skips profile creation
- OAuth callback sets user_type via updateUser()
- This UPDATE trigger fires and creates the profile

For mobile sign-ins without prior signup:
- User_type is never set, so no profile is created
- App can check for missing profile to show "No Account Found"';
...
CREATE TABLE IF NOT EXISTS "public"."client_profiles" (
    ...
    "signin_method" character varying(20) DEFAULT 'email'::character varying,
...
CREATE TABLE IF NOT EXISTS "public"."user_profiles" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "user_profiles_signin_method_check" CHECK ((("signin_method")::"text" = ANY ((ARRAY['email'::character varying, 'google'::character varying])::"text"[]))),
...
CREATE TABLE IF NOT EXISTS "public"."coach_client_assignments" (
    "coach_id" "uuid" NOT NULL,
    "client_id" "uuid" NOT NULL,
    "category" "text" DEFAULT 'online'::"text" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "invitation_token" character varying(8) DEFAULT "gen_random_uuid"(),
    CONSTRAINT "check_no_self_assignment" CHECK (("coach_id" <> "client_id")),
    CONSTRAINT "coach_client_assignments_category_check" CHECK (("category" = ANY (ARRAY['online'::"text", 'in-person'::"text", 'hybrid'::"text"]))),
    CONSTRAINT "coach_client_assignments_status_check" CHECK (("status" = ANY (ARRAY['invited'::"text", 'connected'::"text", 'archived'::"text"])))
);
...
CREATE OR REPLACE VIEW "public"."coach_clients_view" WITH ("security_invoker"='true') AS
 SELECT "cca"."coach_id",
    ...
    "cca"."connected_at",
    "cca"."created_at",
    COALESCE("up"."name", 'Unknown'::character varying) AS "full_name",
    COALESCE("up"."email", "cp"."email", 'No Email'::character varying) AS "email",
    "up"."profile_picture_url" AS "avatar_url",
    "cp"."phone",
    "cp"."gender",
    "cp"."date_of_birth"
   FROM (("public"."coach_client_assignments" "cca"
     JOIN "public"."user_profiles" "up" ON (("up"."id" = "cca"."client_id")))
...
CREATE TABLE IF NOT EXISTS "public"."coach_profiles" (
    ...
    "name" character varying(200) NOT NULL,
    "profile_picture_url" "text",
    "signin_method" character varying(20) DEFAULT 'email'::character varying NOT NULL,
    "is_active" boolean DEFAULT true NOT NULL,
    "is_archived" boolean DEFAULT false NOT NULL,
    ...
    CONSTRAINT "coach_profiles_signin_method_check" CHECK ((("signin_method")::"text" = ANY ((ARRAY['email'::character varying, 'google'::character varying])::"text"[]))),
...
CREATE TABLE IF NOT EXISTS "public"."coach_sections" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "coach_sections_section_type_check" CHECK (("section_type" = ANY (ARRAY['regular'::"text", 'amrap'::"text", 'timed'::"text", 'circuits'::"text", 'auxiliary'::"text"])))
);
...
CREATE POLICY "System can insert coach profiles" ON "public"."coach_profiles" FOR INSERT WITH CHECK (true);
...
CREATE POLICY "Users add reactions" ON "public"."message_reactions" FOR INSERT WITH CHECK ((("user_id" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM "public"."conversations" "c"
  WHERE (("c"."id" = "message_reactions"."conversation_id") AND (("c"."coach_id" = "auth"."uid"()) OR ("c"."client_id" = "auth"."uid"())))))));
...
CREATE POLICY "Users can read own profile" ON "public"."user_profiles" FOR SELECT TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "id"));
...
CREATE POLICY "Users create own conversations" ON "public"."conversations" FOR INSERT WITH CHECK ((("auth"."uid"() = "coach_id") OR ("auth"."uid"() = "client_id")));



CREATE POLICY "Users delete own messages" ON "public"."messages" FOR DELETE USING (("sender_id" = "auth"."uid"()));



CREATE POLICY "Users edit own messages" ON "public"."messages" FOR UPDATE USING (("sender_id" = "auth"."uid"())) WITH CHECK (("sender_id" = "auth"."uid"()));



CREATE POLICY "Users insert own read receipts" ON "public"."message_read_receipts" FOR INSERT WITH CHECK (("user_id" = "auth"."uid"()));
...
CREATE POLICY "Users send messages" ON "public"."messages" FOR INSERT WITH CHECK ((("sender_id" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM "public"."conversations" "c"
  WHERE (("c"."id" = "messages"."conversation_id") AND (("c"."coach_id" = "auth"."uid"()) OR ("c"."client_id" = "auth"."uid"())))))));



CREATE POLICY "Users update attachments in conversations" ON "public"."message_attachments" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."conversations" "c"
  WHERE (("c"."id" = "message_attachments"."conversation_id") AND (("c"."coach_id" = "auth"."uid"()) OR ("c"."client_id" = "auth"."uid"()))))));



CREATE POLICY "Users update own participant records" ON "public"."conversation_participants" FOR UPDATE USING (("user_id" = "auth"."uid"())) WITH CHECK (("user_id" = "auth"."uid"()));



CREATE POLICY "Users update own read receipts" ON "public"."message_read_receipts" FOR UPDATE USING (("user_id" = "auth"."uid"())) WITH CHECK (("user_id" = "auth"."uid"()));
...
CREATE POLICY "Users view own conversations" ON "public"."conversations" FOR SELECT USING ((("auth"."uid"() = "coach_id") OR ("auth"."uid"() = "client_id")));
...
CREATE POLICY "Users view own participant records" ON "public"."conversation_participants" FOR SELECT USING (("user_id" = "auth"."uid"()));
...
CREATE POLICY "Users view read receipts" ON "public"."message_read_receipts" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."conversations" "c"
  WHERE (("c"."id" = "message_read_receipts"."conversation_id") AND (("c"."coach_id" = "auth"."uid"()) OR ("c"."client_id" = "auth"."uid"()))))));
...
CREATE POLICY "client_updates_select_policy" ON "public"."client_updates" FOR SELECT USING ((("coach_id" = "auth"."uid"()) OR ("client_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."client_profiles" "cp"
  WHERE (("cp"."client_id" = "client_updates"."client_id") AND ("cp"."client_id" = "auth"."uid"()))))));
...
CREATE POLICY "cteh_select" ON "public"."client_training_exercise_history" FOR SELECT TO "authenticated" USING (((( SELECT "auth"."uid"() AS "uid") = "client_id") OR (( SELECT "auth"."uid"() AS "uid") = "coach_id")));
...
GRANT ALL ON FUNCTION "public"."block_file_path_change"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."create_conversation_on_client_assignment"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."create_participant_records"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."enforce_checkin_assignment_integrity"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."enforce_checkin_log_integrity"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."enforce_coach_private_integrity"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."enforce_file_assignment_integrity"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."enforce_habit_assignment_integrity"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."enforce_habit_log_integrity"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."enforce_metric_assignment_integrity"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."enforce_metric_entry_integrity"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."enforce_metric_log_integrity"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."enforce_photo_log_integrity"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."enforce_quest_assignment_integrity"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."enforce_quest_log_integrity"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."enforce_todolist_client_belongs_to_coach"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."generate_short_id"("p_len" integer) TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_coach_notification_settings"("coach_uuid" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_or_create_conversation"("p_coach_id" "uuid", "p_client_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_profile_picture_url"("user_metadata" "jsonb") TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_signin_method"("user_metadata" "jsonb") TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_user_type"("user_metadata" "jsonb") TO "anon";
...
GRANT ALL ON FUNCTION "public"."handle_client_account_deletion"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."handle_client_auth_cleanup"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."handle_new_coach_setup"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."handle_user_profile_delete"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."mark_checklist_automate_onboardings"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."mark_checklist_check_ins_forms_questionnaire"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."mark_checklist_custom_exercises"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."mark_checklist_lifestyle_habits"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."mark_checklist_on_demand_resources"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."mark_checklist_powerful_flows"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."mark_checklist_program_templates"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."mark_checklist_track_metrics"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."mark_checklist_workout_ai"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."protect_checkin_review_fields"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."protect_client_profile_fields"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."resolve_coach_item_name_conflict"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."set_client_item_coach_id"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."set_habit_log_updated_fields"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."set_training_summary_updated_by"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."update_message_status_on_read"() TO "anon";
