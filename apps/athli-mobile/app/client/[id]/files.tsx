...
import { ChevronLeft, Plus, Share } from 'lucide-react-native';
        ...
        <ScreenWrapper>
            <View style={[styles.header, { backgroundColor: themeColors.pageBackground }]}>
                <IconButton
                    ...
                    color={iconColor}
                />
                <Text style={[styles.headerTitle, { color: themeColors.text }]}>{t('clientDetail.sections.files')}</Text>
            ...
            <View style={styles.content}>
                <Text style={{ color: themeColors.mutedText }}>{t('clientDetail.filesPlaceholder')}</Text>
            </View>
        </ScreenWrapper>
    );
}
