        ...
        >
            ...
            <View style={[styles.fixedHeader, { height: headerHeight }]}>
                ...
                >
                    ...
                    <Text style={[styles.title, { color: themeColors.text }]}>
                        {t('clientDetail.addGoalModal.title')}
                    </Text>
                    <IconButton
            ...
            >
                <View style={styles.formSection}>
                    <InputBox
                        label={t('clientDetail.addGoalModal.goalTitle')}
                        value={title}
                        onChangeText={setTitle}
                        placeholder={t('clientDetail.addGoalModal.goalTitlePlaceholder')}
                        required
                    />

                    <SelectionInput
                        label={t('clientDetail.addGoalModal.goalDate')}
