/**
 * Messaging Service - Unified Supabase Implementation
 * Handles all messaging operations for both coaches and clients
 * Used by both chats (coach view) and inbox (client view)
 */
...
// Re-export types for use in wrapper services
export type {
  Conversation,
  Message,
  MessageReaction,
...
export const getConversations = async ({
  ...
  try {
    ...
    console.error('[ChatsService] Error getting conversations:', error);
    throw error;
  }
};
 ...
 */
// Re-export createOptimisticMessage from shared package
...
export const removeReaction = async (
  ...
  try {
    ...
    console.error('[ChatsService] Error removing reaction:', error);
    throw error;
  }
};
...
export const markConversationAsRead = async (
  ...
  try {
    ...
    console.error('[ChatsService] Error marking conversation as read:', error);
    throw error;
  }
};
...
export const markAllConversationsAsRead = async (
  ...
  try {
    ...
    console.error('[ChatsService] Error marking all as read:', error);
    throw error;
  }
};
...
export const archiveConversation = async (
  ...
  try {
    ...
    console.error('[ChatsService] Error archiving conversation:', error);
    throw error;
  }
};
...
export const unarchiveConversation = async (
  ...
  try {
    ...
    console.error('[ChatsService] Error unarchiving conversation:', error);
    throw error;
  }
};
...
export const unarchiveAllConversations = async (
  ...
  try {
    ...
    console.error('[ChatsService] Error unarchiving all:', error);
    throw error;
  }
};
...
export const deleteMessage = async (
  ...
  try {
    ...
    console.error('[ChatsService] Error deleting message:', error);
    throw error;
  }
};
...
export const deleteAllArchivedConversations = async (
  ...
  try {
    ...
    console.error('[ChatsService] Error deleting archived conversations:', error);
    throw error;
  }
};
...
export const pinConversation = async (
  ...
  try {
    ...
    console.error('[ChatsService] Error pinning conversation:', error);
    throw error;
  }
};
...
export const unpinConversation = async (
  ...
  try {
    ...
    console.error('[ChatsService] Error unpinning conversation:', error);
    throw error;
  }
};
...
export const muteConversation = async (
  ...
  try {
    ...
    console.error('[ChatsService] Error muting conversation:', error);
    throw error;
  }
};
...
export const unmuteConversation = async (
  ...
  try {
    ...
    console.error('[ChatsService] Error unmuting conversation:', error);
    throw error;
  }
};
 ...
 */
export const getChats = (coachId: string) =>
  getConversations({ coachId, includeArchived: false });

/**
 * @deprecated Use getArchivedConversations instead
 */
export const getArchivedChats = (coachId: string) =>
  getArchivedConversations(coachId);
...
/**
 * @deprecated Use unarchiveConversation instead
 */
export const unarchiveChat = (conversationId: string, userId: string) =>
  unarchiveConversation(conversationId, userId);

/**
 * @deprecated Use deleteAllArchivedConversations instead
 */
export const deleteChat = (conversationId: string, userId: string) =>
  deleteMessage(conversationId, userId);

/**
 * @deprecated Use markAllConversationsAsRead instead
 */
export const readAllChats = (userId: string) =>
  markAllConversationsAsRead(userId);

/**
 * @deprecated Use archiveConversation instead
 */
export const archiveChat = (conversationId: string, userId: string) =>
  archiveConversation(conversationId, userId);

/**
 * @deprecated Use markConversationAsRead instead
 */
export const markChatAsRead = (conversationId: string, userId: string) =>
...
/**
 * @deprecated Use unarchiveAllConversations instead
 */
export const unarchiveAllChats = (userId: string) =>
  unarchiveAllConversations(userId);

/**
 * @deprecated Use deleteAllArchivedConversations instead
 */
export const deleteAllArchivedChats = (userId: string) =>
  deleteAllArchivedConversations(userId);

/**
 * @deprecated Use unarchiveAllConversations + markAllConversationsAsRead instead
 */
export const markAllArchivedAsRead = async (userId: string) => {
  ...
  // Mark each as read
  await Promise.all(
    participants.map((p) => markConversationAsRead(p.conversation_id, userId)),
  );
};
