...
export type TypographyStyle = Pick<TextStyle, 'fontSize' | 'fontWeight' | 'fontFamily'>;
...
export const typography: Record<TextVariant, TypographyStyle> = {
  ...
  h3: { fontSize: 26, fontWeight: '600', fontFamily: headingFontFamily },
  h4: { fontSize: 22, fontWeight: '600', fontFamily: headingFontFamily },
  h5: { fontSize: 20, fontWeight: '600', fontFamily: headingFontFamily },
  h6: { fontSize: 18, fontWeight: '600', fontFamily: headingFontFamily },
  h7: { fontSize: 16, fontWeight: '600', fontFamily: headingFontFamily },
  h8: { fontSize: 14, fontWeight: '600', fontFamily: headingFontFamily },
