...
export const AddClientModal = ({ visible, onClose, onClientAdded }: AddClientModalProps) => {
  ...
  return (
    <BottomSheetModal visible={visible} onClose={handleClose} title={t('clients.addClientModal.title')} height="80%">
      <View style={[styles.modalContent, { minHeight: modalContentMinHeight }]}>
