            ...
            <div className="flex items-center gap-1.5">
              ...
              <Tooltip>
                ...
                <TooltipContent className="max-w-[250px]">
                  <p>A workout is a group of exercises and is for one day.</p>
                </TooltipContent>
              </Tooltip>
            </div>
          </div>
                        ...
                        case "description":
                          return (
                            <React.Fragment key={columnId}>
                              {renderColumnHeader(columnId, <FileText className="size-4" />, "Description", "A brief overview of the workout program")}
                            </React.Fragment>
                          )
                        case "type":
                          return (
                            <React.Fragment key={columnId}>
                              {renderColumnHeader(columnId, <Tag className="size-4" />, "Type", "The category or style of the workout program")}
                            </React.Fragment>
                          )
                        case "length":
                          return (
                            <React.Fragment key={columnId}>
                              {renderColumnHeader(columnId, <Clock className="size-4" />, "Length", "The duration of the workout program")}
                            </React.Fragment>
                          )
                        case "totalExercises":
                          return (
                            <React.Fragment key={columnId}>
                              {renderColumnHeader(columnId, <Hash className="size-4" />, "Total Exercises", "The number of exercises in the workout program")}
                            </React.Fragment>
                          )
                        case "equipment":
                          return (
                            <React.Fragment key={columnId}>
                              {renderColumnHeader(columnId, <Wrench className="size-4" />, "Equipment", "The equipment required for this workout program")}
                            </React.Fragment>
                          )
                        case "created":
                          return (
                            <React.Fragment key={columnId}>
                              {renderColumnHeader(columnId, <Calendar className="size-4" />, "Created", "The date when the workout program was created")}
                            </React.Fragment>
                          )
                        default:
                          return null
