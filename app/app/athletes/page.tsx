                        ...
                        case "lastActivity":
                          return (
                            <React.Fragment key={columnId}>
                              {renderColumnHeader(columnId, <ClockAlert className="size-4" />, "Last activity", "Time since last logged on to app")}
                            </React.Fragment>
                          )
                        case "last7DaysTraining":
                          return (
                            <React.Fragment key={columnId}>
                              {renderColumnHeader(columnId, <Dumbbell className="size-4" />, "L7D Training", "How much they trained in the last 7 days out of their total assigned schedule")}
                            </React.Fragment>
                          )
                        case "last30DaysTraining":
                          return (
                            <React.Fragment key={columnId}>
                              {renderColumnHeader(columnId, <Dumbbell className="size-4" />, "L30D Training", "How much they trained in the last 30 days out of their total assigned schedule")}
                            </React.Fragment>
                          )
                        case "category":
                          return (
                            <React.Fragment key={columnId}>
                              {renderColumnHeader(columnId, <Grid2x2 className="size-4" />, "Category", "Whether or not they are online or in person")}
                            </React.Fragment>
                          )
                        case "connected":
                          return (
                            <React.Fragment key={columnId}>
                              {renderColumnHeader(columnId, <HeartPulse className="size-4" />, "Connected?", "The status of the user's app, i.e. if they have connected to the app")}
                            </React.Fragment>
                          )
                        case "email":
                          return (
                            <React.Fragment key={columnId}>
                              {renderColumnHeader(columnId, <Mail className="size-4" />, "Email")}
                            </React.Fragment>
                          )
                        case "phone":
                          return (
                            <React.Fragment key={columnId}>
                              {renderColumnHeader(columnId, <Phone className="size-4" />, "Phone")}
                            </React.Fragment>
                          )
                        case "country":
                          return (
                            <React.Fragment key={columnId}>
                              {renderColumnHeader(columnId, <Globe className="size-4" />, "Country")}
                            </React.Fragment>
                          )
                        case "age":
                          return (
                            <React.Fragment key={columnId}>
                              {renderColumnHeader(columnId, <User className="size-4" />, "Age")}
                            </React.Fragment>
                          )
                        case "clientFor":
                          return (
                            <React.Fragment key={columnId}>
                              {renderColumnHeader(columnId, <ClockAlert className="size-4" />, "Client For", "How long they have been a client")}
                            </React.Fragment>
                          )
                        default:
                          return null
